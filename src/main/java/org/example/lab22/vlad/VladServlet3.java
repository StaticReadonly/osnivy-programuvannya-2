...
public class VladServlet3 extends HttpServlet {
    ...
    private void forwardToJspFile(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        request.getRequestDispatcher("vlad-form3.jsp").forward(request, response);
    }
    ...
    private void setCookie(HttpServletResponse response, String value){
        ...
        cookie.setPath("/lab2_2_war_exploded/vlad-form3");
    ...
    private void deleteCookie(HttpServletResponse response){
        ...
        deleteCookie.setPath("/lab2_2_war_exploded/vlad-form3");
